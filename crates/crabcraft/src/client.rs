...
fn updated_air(current: i32, head_submerged: bool, vulnerable: bool) -> i32 {
    if !vulnerable {
        return 300;
    }
    if head_submerged {
    ...
    loop {
        tokio::select! {
            ...
            result = conn.read_packet() => {
                ...
                if matches!(protocol, ProtocolVersion::V1_21_6 | ProtocolVersion::V1_21_7) && raw.id == 0x6f {
                ...
                if matches!(
                    ...
                    match raw.id {
                        ...
                        0x65 => {
                            ...
                            let decoded = if matches!(protocol, ProtocolVersion::V1_21_6 | ProtocolVersion::V1_21_7) {
                ...
                match packet_id {
                    ...
                    id if id == ID_MAP_CHUNK => {
                        ...
                        } else if matches!(protocol, ProtocolVersion::V1_21_6 | ProtocolVersion::V1_21_7) {
    ...
    S: AsyncRead + AsyncWrite + Unpin,
{
    if matches!(
        ...
        conn.send_unmapped(&play771::UseItem(play770::UseItem {
            hand: 0,
            sequence,
            yaw,
            pitch,
...
mod tests {
    ...
    fn underwater_air_drains_and_recovers_at_vanilla_rates() {
        assert_eq!(updated_air(300, true, true), 299);
        assert_eq!(updated_air(1, true, true), 0);
        assert_eq!(updated_air(0, true, true), 0);
        assert_eq!(updated_air(100, false, true), 104);
        assert_eq!(updated_air(299, false, true), 300);
        assert_eq!(updated_air(12, true, false), 300);
    }
